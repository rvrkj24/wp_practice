...
function asbab_ecommerce() {
    ...
    wp_register_script('asbab-jquery-latest', get_template_directory_uri() .'/js/jquery-3.2.1.min.js', array(), true);
    ...
    wp_enqueue_script('asbab-jquery-latest');
    wp_enqueue_script('main-asbab-js', get_theme_file_uri('/js/main.js'), microtime(), true);
    ...
    wp_enqueue_style('asbab_ecommerce_main_styles', get_stylesheet_uri(), microtime());
